...
import com.prince.thesis.utils.MyApplication;
...
//        });
    ...
    public void login() {
        ...
        if (email.equals("j@j.com") && password.equals("654321")){
    ...
    public void onLoginSuccess() {
        ...
        SharePreferenceSingleton.getInstance(this).saveBoolean("login", true);
