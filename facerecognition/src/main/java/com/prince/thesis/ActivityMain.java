...
public class ActivityMain extends AppCompatActivity
    ...
    static String courseStringShared = "courseStringShared";
    static String allUserString = "";
    static String allUserStringShared = "allUserStringShared";
    static String teacherUserString = "";
    static String teacherUserStringShared = "teacherUserStringShared";
    static String notTeacherUserString = "";
    static String notTeacherUserStringShared = "notTeacherUserStringShared";
    static String studentUserString = "";
    static String studentUserStringShared = "studentUserStringShared";
    static String crUserString = "";
    static String crUserStringShared = "crUserStringShared";
...
//                SharePreferenceSingleton.getInstance(MyApplication.getInstance()).saveString(ActivityMain.courseStringShared, courseString);
                ActivityMain.flg = 1;
            }
        ...
        databaseReference.child("student").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                if(user.getRole().contains("!teacher"))
                {
                  ...
                  //  SharePreferenceSingleton.getInstance(MyApplication.getInstance()).saveString(ActivityMain.notTeacherUserStringShared, notTeacherUserString);
                }
                ...
                //    SharePreferenceSingleton.getInstance(MyApplication.getInstance()).saveString(ActivityMain.teacherUserStringShared, teacherUserString);
                ...
                else if(user.getRole().contains("cr"))
                {
                 ...
                 //   SharePreferenceSingleton.getInstance(MyApplication.getInstance()).saveString(ActivityMain.crUserStringShared, crUserString);
                ...
                else if(user.getRole().contains("student"))
                {
                 ...
                 //   SharePreferenceSingleton.getInstance(MyApplication.getInstance()).saveString(ActivityMain.studentUserStringShared, studentUserString);
              ...
              //  SharePreferenceSingleton.getInstance(MyApplication.getInstance()).saveString(ActivityMain.allUserStringShared, allUserString);
...
//        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference();
//        mDatabase.child("notification").child(ketNotification).child("sent").setValue("1");


    }

    public void selfNotify(String title, String msg, String ketNotification){
    ...
    public void getNotification(final String ketNotification) {
        ...
        if(date.contains(todayDate) && todayDate.length() == date.length())
        {
            ...
            mDatabase.child("notification").child(ketNotification).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (map.get("sent") != null && map.get("sent").equals("1")){
                        return;
                    }

                    try{
                        selfNotify(title,msg, ketNotification);
                    }catch (Exception e)
                    {
...
//                    try{
//                        showNotification(ActivityMain.this,title,msg,getIntent(), ketNotification);
//                    }catch (Exception e)
//                    {
...
//                    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //getMenuInflater().inflate(R.menu.activity_main_recognizer, menu);
        return true;
    }
