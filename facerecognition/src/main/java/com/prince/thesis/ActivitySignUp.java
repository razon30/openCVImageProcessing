...
public class ActivitySignUp extends AppCompatActivity {
    ...
    @BindView(R.id.input_email_parent) EditText _emailTextParent;
    ...
    @BindView(R.id.parent_container) TextInputLayout parentContainer;
    ...
    public void signup() {
        ...
        final String emailparent = _emailText.getText().toString();
                                    ...
                                    new Runnable() {
                                        public void run() {
                                            ...
                                            if (radioFlg)
                                                ...
                                                studentInfo = new userInfo(name,reg,email,"student","",emailparent);
...
;
    ...
    public boolean validate() {
        ...
        String emailParent = _emailTextParent.getText().toString();
        ...
        if ((reg.isEmpty() || reg.length() != 6) && radioFlg == false) {
            _regText.setError("Must be 6 digits");
            valid = false;
        }
        ...
        if (!radioFlg) {
            ...
            if (emailParent.isEmpty() || !android.util.Patterns.EMAIL_ADDRESS.matcher(emailParent).matches()) {
                _emailTextParent.setError("Enter a valid email address");
                valid = false;
            } else {
                _emailTextParent.setError(null);
            }
